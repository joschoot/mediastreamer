...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="../index.php">Media Streamer</a>
    ...
    <div class="container">
      ...
      <h1 class="my-4 text-center text-lg-left">Uploaded video's</h1>
...
<div class="col-lg-3 col-md-4 col-xs-6"> <center><h3>Funny Bunny</h3></center> <a href="https://media.schroeff.nl/pages/245.php" class="d-block mb-4 h-100"> <img class="img-fluid img-thumbnail" src="/thumbnails/245.png" <h4>2019/01/23 12:46</h4> </a> </div>
    ...
    <footer class="py-5 bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright © Team VT18</p>
      </div>
      <!-- /.container -->
    </footer>
